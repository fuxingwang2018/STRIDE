...
npz_folder='/mimer/NOBACKUP/groups/naiss2025-6-138/HCLIMAI/STRIDE_RUNS/pipeline_norcp_pr_zscore_ep100/generation/samples/'
out_folder='/mimer/NOBACKUP/groups/naiss2025-6-138/HCLIMAI/STRIDE_RUNS/pipeline_norcp_pr_zscore_ep100/generation/samples/netcdf/'
...
python test_scripts/npz_to_netcdf4.py $npz_folder  --out $out_folder #/mimer/.../generation/samples/

# Convert only ensemble_members
#python npz_to_netcdf.py /mimer/.../generation/samples/ --product ensemble_members

# Specify output dir
#python npz_to_netcdf.py /mimer/.../generation/samples/ --out /mimer/.../netcdf/
